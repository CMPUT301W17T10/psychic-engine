...
public class CreateMoodActivity extends AppCompatActivity {
    ...
    // for displaying the browsed image
    @Override
    ...
    void createMoodEvent() {
        ...
        switch(moodString) {        // TODO refactor this - inside MoodState enum class?
            case "Sad": mood.setMood(MoodState.SAD); break;
            case "Happy": mood.setMood(MoodState.HAPPY); break;
            case "Shame": mood.setMood(MoodState.SHAME); break;
            case "Fear": mood.setMood(MoodState.FEAR); break;
            case "Anger": mood.setMood(MoodState.ANGER); break;
            case "Surprised": mood.setMood(MoodState.SURPRISED); break;
            case "Disgust": mood.setMood(MoodState.DISGUST); break;
            case "Confused": mood.setMood(MoodState.CONFUSED); break;
        }
